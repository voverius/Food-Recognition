...
def get_model(model_name, include_top, weights):
    if model_name == 'ResNet152V2':
        ...
        model =  tf.keras.applications.InceptionV3(include_top=include_top, weights=weights, input_tensor=None, input_shape=None, pooling=None, classes=102, classifier_activation="softmax")
        model.trainable = False
    elif model_name == 'VGG16':
        model =  tf.keras.applications.VGG16(include_top=include_top, weights=weights, input_tensor=None, input_shape=None, pooling=None, classes=102, classifier_activation="softmax")
        model.trainable = False
